...
for (const [locale, page] of Object.entries(pages)) {
  const renderLocale = page.path.startsWith("/destinos/") || page.path.startsWith("/modalidades/") || page.path.startsWith("/sobre") || page.path.startsWith("/pet-luxo") ? "pt-BR" : locale;
