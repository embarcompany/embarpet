...
export const countryAliases: Record<string, string[]> = {
  BR: ["brasil", "brazil", "bresil", "brasile", "bra", "br", "pindorama"],
  US: ["eua", "usa", "estados unidos", "united states", "eeuu", "america", "us", "u.s.a", "e.u.a", "estados unidos da america"],
  PT: ["portugal", "pt", "terras lusitanas", "lisboa", "porto"],
  GB: ["reino unido", "inglaterra", "uk", "united kingdom", "great britain", "gra-bretanha", "gra bretanha", "londres", "england", "scotland", "escocia", "gb"],
  ES: ["espanha", "spain", "espana", "es", "madrid", "barcelona"],
  FR: ["franca", "france", "francia", "fr", "paris"],
  DE: ["alemanha", "germany", "deutschland", "alemania", "de", "berlim", "munique"],
  IT: ["italia", "italy", "it", "roma", "milao"],
  CA: ["canada", "ca", "toronto", "vancouver", "montreal"],
  AR: ["argentina", "ar", "buenos aires"],
  UY: ["uruguai", "uruguay", "uy", "montevideu"],
  PY: ["paraguai", "paraguay", "py", "assuncao"],
  CL: ["chile", "cl", "santiago"],
  JP: ["japao", "japan", "japon", "jp", "tokyo", "toquio"],
  AU: ["australia", "au", "sydney", "melbourne"],
  IE: ["irlanda", "ireland", "ie", "dublin"],
  CH: ["suica", "switzerland", "suisse", "suiza", "ch", "zurique", "genebra"],
  NL: ["holanda", "paises baixos", "netherlands", "holland", "nl", "amsterdam"],
  BE: ["belgica", "belgium", "belgique", "be", "bruxelas"],
  AE: ["emirados arabes", "dubai", "uae", "emirates", "emirados", "ae", "abu dhabi"],
};
