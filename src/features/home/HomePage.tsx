...
export default function EmbarpetHome({ isLp = false }: { isLp?: boolean }) {
  ...
  return <>
    ...
    <section className="ep-home-modalities" id="modalidades"><div className="ep-container"><div className="ep-home-modalities__intro"><div><p className="ep-eyebrow">Modalidades de embarque</p><h2 className="ep-title-lg">Entenda como seu pet pode <em>viajar de avião.</em></h2></div><p className="ep-copy">Cabine, bagagem acompanhada, compartimento de cargas e suporte emocional funcionam de maneiras diferentes. Conheça cada modalidade antes de avaliarmos qual pode fazer sentido para o seu pet, a sua rota e a sua família.</p></div>
      <ModalityRail items={[
        { icon:"plane", title:"Viagem na cabine", copy:"Seu pet viaja com você dentro da cabine, acomodado em uma bolsa ou caixa aprovada pela companhia aérea. É a alternativa que mantém vocês mais próximos durante o voo quando porte, peso e rota atendem aos critérios.", ctaLabel:"Avaliar modalidade", detailHref:"/modalidades/viagem-na-cabine", imageSrc:"/embarpet-modalidade-viagem-cabine.jpg", imageAlt:"Cachorro observando a paisagem pela janela durante uma viagem na cabine" },
