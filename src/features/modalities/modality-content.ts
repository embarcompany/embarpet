...
export const modalityContent: Record<ModalitySlug, ModalityContent> = {
  "compartimento-de-cargas": {
    ...
    title: "Garanta um voo seguro",
    titleHighlight: "para o seu pet.",
    intro: "Rota, raça e a data escolhida definem se o compartimento de cargas é a alternativa mais segura para a viagem.",
...
export const modalityStorytelling: Record<ModalitySlug, {
  ...
  "viagem-na-cabine": {
    reassuranceTitle: "Cada critério é conferido",
    reassuranceTitleHighlight: "antes de prometer a cabine.",
  ...
  "bagagem-acompanhada": {
    reassuranceTitle: "Companhia, rota e caixa são conferidas",
    reassuranceTitleHighlight: "antes de qualquer reserva.",
  ...
  "suporte-emocional": {
    reassuranceTitle: "Cada caso passa por uma análise",
    reassuranceTitleHighlight: "completa e honesta.",
