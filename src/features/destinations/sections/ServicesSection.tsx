...
export function ServicesSection({
  ...
  return <section className="ep-destination-services" aria-labelledby="destination-services-title"><div className="ep-container"><div className="ep-destination-services__heading"><p className="ep-us-kicker">Nossos serviços</p><h2 id="destination-services-title">{destination.servicesHeading}<br className="ep-destination-services__title-break" /> <em>{destination.servicesHeadingHighlight}</em></h2><p>{destination.servicesIntro}</p></div><div className="ep-destination-services__grid">{destination.services.map(({ icon, title, copy, variant }) => {
