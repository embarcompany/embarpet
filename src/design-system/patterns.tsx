...
export function AuthorityBand() {
  return <section className="ep-authority-band" aria-label="Números e credenciais da Embarpet">
    ...
    <div className="ep-authority-band__credential ep-authority-band__credential--associations"><strong><img src="/logo-ipata.svg" alt="IPATA" /><img src="/logo-iata.svg" alt="IATA" /></strong><span>Credenciados</span></div>
