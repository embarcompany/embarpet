...
const copy = {
  "pt-BR": {
    ...
    heroTitleBefore: "Vai viajar com seu ", heroTitleHighlight: "pet pra outro país?", heroIntro: "Para o transporte internacional do seu pet, responda em poucos passos e receba uma ", heroIntroStrong: "previsão personalizada", heroIntroAfter: " para o embarque.",
