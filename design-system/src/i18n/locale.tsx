...
const copy = {
  "pt-BR": {
    ...
    heroTitleBefore: "Vai viajar com seu ", heroTitleHighlight: "pet pra outro país?", heroIntro: "Conte com a experiência de mais de 2.000 embarques analisados. Responda em poucos passos e receba uma ", heroIntroStrong: "previsão personalizada", heroIntroAfter: " para a viagem de você e seu pet.",
  ...
  en: {
    ...
    period: "When would you like to travel?", periodOptions: ["Within 1 to 3 months", "Within 3 to 6 months", "No date set"], origin: "Where is your pet leaving from?", destination: "Where is your pet going?", cityPlaceholder: "Enter a city", originRequired: "Enter the departure city", destinationRequired: "Enter the destination city", startAnalysis: "Start my assessment",
  ...
  es: {
    ...
    period: "¿Cuándo deseas viajar?", periodOptions: ["Dentro de 1 a 3 meses", "Dentro de 3 a 6 meses", "Sin fecha definida"], origin: "¿De dónde sale tu mascota?", destination: "¿Adónde va tu mascota?", cityPlaceholder: "Escribe una ciudad", originRequired: "Indica la ciudad de origen", destinationRequired: "Indica la ciudad de destino", startAnalysis: "Comenzar mi evaluación",
  ...
  ja: {
    ...
    period: "渡航予定はいつですか？", periodOptions: ["1〜3か月以内", "3〜6か月以内", "日程未定"], origin: "ペットの出発地は？", destination: "ペットの渡航先は？", cityPlaceholder: "都市名を入力", originRequired: "出発都市を入力してください", destinationRequired: "目的地の都市を入力してください", startAnalysis: "確認を始める",
