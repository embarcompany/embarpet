...
export function SiteHeader({ logoSrc, items, cta, utilityItems = [], activeLabel, overlay = false, showLanguage = true }: { logoSrc: string; items?: NavigationItem[]; cta?: NavigationLink; utilityItems?: NavigationLink[]; activeLabel?: string; overlay?: boolean; showLanguage?: boolean }) {
