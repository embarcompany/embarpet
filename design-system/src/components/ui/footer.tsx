  ...
  return (
    <footer className={`ep-site-footer${minimal ? " ep-site-footer--minimal" : ""}`}>
      <div className="ep-container">
        ...
        <div className="ep-footer-bottom"><span>© Embarpet · Todos os direitos reservados</span><span className="ep-footer-credit">Criado por <a href="https://igormarin.com.br" target="_blank" rel="noopener noreferrer"><b>Igor Marin Santos</b></a> · Rastreado por <a href="https://montuan.com.br" target="_blank" rel="noopener noreferrer"><b>Fernando Montuan</b></a></span><div>{showLanguageLink ? <a href="#idioma"><Globe2 size={13} /> PT</a> : null}<a href="/privacidade">Privacidade</a><a href="/termos">Termos de uso</a></div></div>
      </div>
    </footer>
  );
}
