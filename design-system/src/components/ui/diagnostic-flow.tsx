...
import { AnalysisButton, BackButton, InterfaceButton } from "./buttons";
    ...
    >
      ...
      {step === 1 && (
        <div className="ep-flow-card">
          ...
          <h2 className="ep-flow-title">Quem vai viajar?</h2>
          ...
          <div className="ep-flow-fields ep-flow-fields--stack">
            <div className="ep-route-inline ep-route-inline--airport">
              <CityAirportField
                label="Origem"
                value={route.origin}
                onChange={(value) => setRouteField("origin", value)}
              />
              <Plane
                className="ep-route-inline__arrow"
                size={17}
                aria-hidden="true"
              />
              <CityAirportField
                ...
                onChange={(value) => setRouteField("destination", value)}
              />
            </div>
            <div className="ep-travel-timing">
              <label className="ep-field">
                <span>Quando pretende viajar?</span>
                {hasSpecificDate ? (
                  <input
                    type="month"
                    value={route.period}
                    onChange={(event) =>
                      setRouteField("period", event.target.value)
                    }
                  />
                ) : (
                  <TravelPeriodSelect
        ...
        <div className="ep-flow-card">
          ...
          <div className="ep-flow-summary">
            ...
            <span className="ep-flow-summary__content">
              ...
              <b>
                {route.origin} <i>→</i> {route.destination}
              </b>
              <em>
      ...
      {step === 4 && sent && (
        <div className="ep-flow-card ep-flow-success">
          ...
          <AnalysisButton size="lg">Continuar no WhatsApp</AnalysisButton>
          <small>
    ...
    <div className="ep-flow-route-preview" aria-live="polite">
      ...
      <span className="ep-flow-route-preview__content">
        ...
        <span className="ep-flow-route-preview__main">
          <b>
            <span title={origin}>{origin || "Origem"}</span>
            <i>→</i>
            <span title={destination}>{destination || "Destino"}</span>
          </b>
...
function FlowActions({
  ...
  return (
    ...
    >
      ...
      {back ? (
        <BackButton fullWidth size="lg" type="button" onClick={back}>
          Voltar
        </BackButton>
      ) : null}
      <InterfaceButton
