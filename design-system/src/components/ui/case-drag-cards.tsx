...
export function CaseDragCards({ cases }: { cases: CaseCard[] }) {
  ...
  if (isMobile) return <div className="ep-case-carousel" aria-label="Histórias de famílias atendidas pela Embarpet">
    <div className="ep-case-carousel__heading"><div className="ep-case-canvas__proof"><p className="ep-eyebrow"><strong>+2.000</strong> embarques realizados</p><span className="ep-case-google"><img src="/logo-google.svg" alt="Google" /><b>4,9</b><span aria-label="4,9 estrelas no Google"><Star size={9} fill="currentColor" /><Star size={9} fill="currentColor" /><Star size={9} fill="currentColor" /><Star size={9} fill="currentColor" /><Star size={9} fill="currentColor" /></span></span></div><h2>Histórias de quem<br /><em>confiou na jornada.</em></h2><p>Relatos reais de jornadas acompanhadas pela Embarpet.</p></div>
    ...
    <InternalLink href="/historias">Veja mais histórias</InternalLink>
  </div>;
  return <div className="ep-case-canvas" ref={areaRef} aria-label="Depoimentos de famílias atendidas. Arraste os cartões para explorar.">
    <div className="ep-case-canvas__center"><div className="ep-case-canvas__proof"><p className="ep-eyebrow"><strong>+2.000</strong> embarques realizados</p><span className="ep-case-google"><img src="/logo-google.svg" alt="Google" /><b>4,9</b><span aria-label="4,9 estrelas no Google"><Star size={9} fill="currentColor" /><Star size={9} fill="currentColor" /><Star size={9} fill="currentColor" /><Star size={9} fill="currentColor" /><Star size={9} fill="currentColor" /></span></span></div><h2>Histórias de quem<br /><em>confiou na jornada.</em></h2><p>Arraste os cartões para explorar relatos.</p><InternalLink href="/historias">Veja mais histórias</InternalLink></div>
