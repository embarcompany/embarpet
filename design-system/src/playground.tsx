...
export default function EmbarpetHome() {
  ...
  return <><SiteHeader overlay logoSrc="/logo-embarpet-dark.png" items={[
    ...
    <section className="ep-home-modalities" id="modalidades"><div className="ep-container"><div className="ep-home-modalities__intro"><div><p className="ep-eyebrow">Não existe uma resposta pronta</p><h2 className="ep-title-lg">Antes da modalidade, vem a leitura do seu caso.</h2></div><p className="ep-copy">Cabine, bagagem acompanhada, compartimento de cargas e suporte emocional são possibilidades — nunca uma promessa de prateleira. Rota, perfil do pet e regras vigentes orientam a decisão.</p></div>
      <ModalityRail items={[
        { icon:"plane", title:"Viagem na cabine", copy:"Em algumas rotas, pets dentro dos critérios podem viajar próximos ao tutor.", ctaLabel:"Avaliar viagem na cabine", detailHref:"/modalidades/viagem-na-cabine", imageSrc:"/embarpet-pet-na-cabine.jpeg", imageAlt:"Pets em cabine durante um voo" },
        ...
        { icon:"home", title:"Compartimento de cargas", copy:"Uma operação especializada para perfis, rotas ou viagens que pedem uma estrutura própria.", ctaLabel:"Avaliar compartimento de cargas", detailHref:"/modalidades/compartimento-de-cargas", imageSrc:"/embarpet-carga-viva-operacao.jpeg", imageAlt:"Equipe Embarpet com pets em caixas de transporte no aeroporto" },
        { icon:"shield", title:"Suporte emocional", copy:"Em situações aplicáveis, avaliamos o contexto da viagem e os critérios da companhia aérea para orientar os próximos passos.", ctaLabel:"Avaliar suporte emocional", detailHref:"/modalidades/suporte-emocional", imageSrc:images.documents, imageAlt:"Documentação e planejamento de viagem com pet" },
      ]} />
      <p className="ep-home-bridge">A melhor possibilidade nasce da análise certa — e é isso que começamos a fazer com você.</p>
    </div></section>

    <section className="ep-home-service" id="servicos"><div className="ep-container ep-home-service__grid"><figure className="ep-home-ceo" aria-label="CEO da Embarpet com diferentes espécies de pets"><div className="ep-home-ceo__glow" aria-hidden="true" /><img src="/embarpet-ceo-equipe-trim.png" alt="CEO da Embarpet com cachorro, gato, hamster, ave e tartaruga" /><span className="ep-home-ceo__fade" aria-hidden="true" /></figure><div><p className="ep-eyebrow">Quem somos</p><h2 className="ep-title-lg">Por trás de cada rota, existe uma equipe que cuida dos detalhes.</h2><p className="ep-copy">A Embarpet reúne atendimento, planejamento, documentação e operação para transformar uma viagem complexa em próximos passos claros — com pessoas acompanhando o seu caso de verdade.</p><div className="ep-home-service__list"><span><Route size={19} />Leitura humana da rota, do prazo e do embarque</span><span><Package size={19} />Orientação conectada entre documentos e operação</span><span><ShieldCheck size={19} />Clareza antes de qualquer decisão de viagem</span></div><a className="ep-button ep-button--secondary" href="/equipe-e-credenciais"><span>Conhecer quem faz a Embarpet</span><ArrowRight size={18} aria-hidden="true" /></a></div></div></section>
    ...
    ].map(({ icon: Icon, title, copy, number }, index) => <span className="ep-home-process__satellite" key={title} style={{ "--ep-orbit-delay": `${index * -4.5}s` } as React.CSSProperties}><a className="ep-home-process__cycle-step" href="#analise"><span className="ep-home-process__cycle-icon"><Icon size={20} strokeWidth={1.7} /></span><span><b>{number}</b><strong>{title}</strong><small>{copy}</small></span></a></span>)}</div></div></section>
