...
export default function ThankYouPage() {
  ...
  return <main className="ep-thank-you-page">
    ...
    <section className="ep-thank-you-proof" aria-label="Provas de autoridade da Embarpet"><div><img src="/embarpet-avatar-dog.png" alt="" /><img src="/embarpet-avatar-cat.png" alt="" /><img src="/embarpet-avatar-hamster.png" alt="" /><strong>+2.000<small>embarques analisados</small></strong></div><div><img src="/logo-ipata.webp" alt="IPATA" /><img src="/logo-iata.webp" alt="IATA" /><strong>Credenciada<small>IATA e IPATA</small></strong></div><div><img src="/logo-google.svg" alt="Google" /><strong>4,9 <span aria-label="5 estrelas"><Star size={13} fill="currentColor" /><Star size={13} fill="currentColor" /><Star size={13} fill="currentColor" /><Star size={13} fill="currentColor" /><Star size={13} fill="currentColor" /></span><small>avaliação no Google</small></strong></div></section>
  </main>;
}
