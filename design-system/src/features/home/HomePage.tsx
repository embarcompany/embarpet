...
export default function EmbarpetHome() {
  ...
  return <>{analysisOpen ? <div className="ep-analysis-modal" role="dialog" aria-modal="true" aria-label={text.startAnalysis}><div className="ep-analysis-modal__backdrop" onClick={closeAnalysis} /><section className="ep-analysis-modal__panel"><header><a href={path("/")} aria-label="Embarpet"><img src="/logo-embarpet-dark.png" alt="Embarpet" /></a><button type="button" onClick={closeAnalysis} aria-label={text.close}><X size={21} /></button></header><div className="ep-analysis-modal__content"><DiagnosticFlow routeFirst startAtPet={Boolean(analysisRoute.origin && analysisRoute.destination && analysisRoute.period)} initialRoute={analysisRoute} analyticsSource="index_modal" /></div></section></div> : null}<SiteHeader overlay logoSrc="/logo-embarpet-dark.png" items={[
    ...
    <section className="ep-home-service" id="servicos"><div className="ep-container ep-home-service__grid"><figure className="ep-home-ceo" aria-label="Thamires Félix, da equipe Embarpet, com diferentes espécies de pets"><div className="ep-home-ceo__glow" aria-hidden="true" /><img src="/embarpet-ceo-equipe-trim.webp" alt="Thamires Félix com cachorro, gato, hamster, ave e tartaruga" /><span className="ep-home-ceo__fade" aria-hidden="true" /><figcaption>Thamires Félix <small>Embarpet</small></figcaption></figure><div><p className="ep-eyebrow">Quem cuida da viagem</p><h2 className="ep-title-lg">Uma equipe que transforma regra em próximo passo.</h2><p className="ep-copy">Thamires Félix e uma equipe especializada conectam atendimento, documentação e operação para que uma viagem complexa se transforme em uma jornada clara para a família.</p><ul className="ep-home-service__proofs"><li><ShieldCheck size={17} />Equipe especializada</li><li><MapPin size={17} />Leitura da rota</li><li><Headset size={17} />Acompanhamento da operação</li></ul><a className="ep-button ep-button--secondary" href="/equipe-e-credenciais"><span>Conhecer a equipe Embarpet</span><ArrowRight size={18} aria-hidden="true" /></a></div></div></section>
